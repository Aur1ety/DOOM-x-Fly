...
|---|---|---|---|
| raw weight rows | 151,856,684 | 151,856,684 | ✅ |
| unresolved objects | 33,013 | 33,013 | ✅ |
| non-neuronal excluded | 11,864 | 11,864 | ✅ |
| neurons | 166,700 | 166,700 | ✅ |
| edges | 25,582,938 | 25,582,938 | ✅ |
| synaptic contacts | 124,177,617 | 124,177,617 | ✅ |
...
1. **Scope**: the plan's 20k-neuron cap is incompatible with the 4-hop rule on real MaleCNS; v5 (108k neurons) requires full A30s (state ≈ 10 GB at batch 256 with checkpointing) — i.e. Qwen down during training.
...
## 11. Gate 0 (PLAN M4) — take_cover, brain piece v5, untrained, gain-matched at `rest` (`python -m flybrain.eval.probe`)
...
not ≥ +0.10). Per PLAN K4 the confirmatory tier is cut to one scenario and one null and the effort
